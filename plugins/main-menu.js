...
function _0x1766() {
	const _0x1c60e8 = ['3ezQcUH', '.owner', '.versi', '725770ccnUBU', 'sgc', 'pdf', 'buffer', '305624SHQwwY', '233195fjGJSZ', '72BjUaMS', '2869867kBKaey', 'chat', '6NokiEm', '72PsFaxu', '║🤝║𝐒𝐄𝐖𝐀 𝐁𝐎𝐓║❁', '1832yREmVQ', '205026IsvCrH', '132IBvmfp', '3329164htczQJ', '║👑║𝐍𝐔𝐌𝐁𝐄𝐑 𝐎𝐖𝐍𝐄𝐑║❁', '7315FCLnNH', 'sendMessage', 'sender'];
	_0x1766 = function() {
		return _0x1c60e8;
	};
	return _0x1766();
...
//-------DOC TEMPLATE
    const message = {
            ...
            templateButtons: [
                ...
                {
                    urlButton: {
                        displayText: '║📢║𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 𝐆𝐑𝐎𝐔𝐏 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏║❁',
                        url: sgc
                    }
                },
                {
                ...
                {
                    quickReplyButton: {
                        displayText: '║👑║𝐍𝐔𝐌𝐁𝐄𝐑 𝐎𝐖𝐍𝐄𝐑║❁',
                        id: '.owner'
                    }
                },
                {
                    quickReplyButton: {
                        displayText: '║🌐║𝐆𝐋𝐎𝐁𝐀𝐋 𝐕𝐄𝐑𝐒𝐈𝐎𝐍 𝐁𝐎𝐓║❁',
                        id: '.versibot'
                    }
                },
            ]
...
  } catch (e) { 
     conn.reply(m.chat, '𝗠𝗔𝗔𝗙 𝗠𝗘𝗡𝗨 𝗦𝗘𝗗𝗔𝗡𝗚 𝗘𝗥𝗥𝗢𝗥, 𝗦𝗘𝗚𝗘𝗥𝗔 𝗟𝗔𝗣𝗢𝗥 𝗞𝗘 𝗢𝗪𝗡𝗘𝗥 𝗪𝗔.𝗠𝗘/𝟲𝟮𝟴𝟭𝟮𝟰𝟴𝟱𝟯𝟳𝟬𝟴𝟱', m) 
     throw e 
   } 
 } 
...
function clockStringP(ms) {
  ...
  let m = isNaN(ms) ? '--' : Math.floor(ms / 60000) % 60
  let s = isNaN(ms) ? '--' : Math.floor(ms / 1000) % 60
  return [ye, '𝗬𝗘𝗔𝗥𝗦🗓️\n',  mo, ' 🌙𝗠𝗢𝗡𝗧𝗛\n', d, '𝗗𝗔𝗬𝗦 ☀️\n', h, ' *𝗛𝗢𝗨𝗥𝗦 🕐\n', m, '𝗠𝗜𝗡𝗨𝗧𝗘𝗦 ⏰\n', s, '𝗦𝗘𝗖𝗢𝗡𝗗𝗦 ⏱️'].map(v => v.toString().padStart(2, 0)).join('')
}
function ucapan() {
  const time = moment.tz('Asia/Jakarta').format('HH')
  let res = "𝐒𝐞𝐥𝐚𝐦𝐚𝐭 𝐃𝐢𝐧𝐢𝐇𝐚𝐫𝐢  ☀️"
  if (time >= 4) {
    res = "𝐒𝐞𝐥𝐚𝐦𝐚𝐭 𝐏𝐚𝐠𝐢 🌄"
  }
  if (time >= 10) {
